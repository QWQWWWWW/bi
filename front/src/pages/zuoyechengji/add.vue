...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"none"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="作业成绩" prop="zuoyechengji">
            <el-select v-model="ruleForm.zuoyechengji" placeholder="请选择作业成绩" :disabled=" false  ||ro.zuoyechengji" >
              <el-option
                  v-for="(item,index) in zuoyechengjiOptions"
                  :key="index"
                  :label="item"
                  :value="item">
              </el-option>
