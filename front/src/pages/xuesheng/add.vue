...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"none"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="兴趣课程" prop="kechengfenlei">
            <el-select v-model="ruleForm.kechengfenlei" placeholder="请选择兴趣课程" :disabled=" false  ||ro.kechengfenlei" >
              <el-option
...
<script>
  export default {
    ...
    // 多级联动参数
      ...
      // 提交
      onSubmit() {
			if((this.ruleForm.xueshengxuehao).toString().length<8){
