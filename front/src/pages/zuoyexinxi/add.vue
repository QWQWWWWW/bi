...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"none"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="作业文件" prop="zuoyewenjian">
            <file-upload
            tip="点击上传作业文件"
            action="file/upload"
            :limit="1"
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="作业要求" prop="zuoyeyaoqiu">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="作业要求"
