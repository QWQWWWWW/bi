	...
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="作业成绩" prop="zuoyechengji">
					<el-select :disabled="ro.zuoyechengji" v-model="ruleForm.zuoyechengji" placeholder="请选择作业成绩" >
						<el-option
