	...
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="兴趣课程" prop="kechengfenlei">
					<el-select :disabled="ro.kechengfenlei" v-model="ruleForm.kechengfenlei" placeholder="请选择兴趣课程" >
						<el-option
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="兴趣课程" prop="kechengfenlei">
					<el-input v-model="ruleForm.kechengfenlei"
						placeholder="兴趣课程" readonly></el-input>
				</el-form-item>
			</template>
