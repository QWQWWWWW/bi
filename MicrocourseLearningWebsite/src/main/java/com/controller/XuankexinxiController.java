...
public class XuankexinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,XuankexinxiEntity xuankexinxi,
		...
		if(tableName.equals("jiaoshi")) {
			xuankexinxi.setJiaoshizhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("xuesheng")) {
			xuankexinxi.setXueshengxuehao((String)request.getSession().getAttribute("username"));
		}
